<template>
    ...
    <div class="container mx-auto pt-40 lg:pt-52 2xl:pt-64 pb-16 lg:pb-20 xl:pb-28 2xl:pb-52 flex flex-col px-5 py-24 justify-center items-center max-w-7xl">
        <div class="w-full md:w-2/3 flex flex-col mb-6 text-center">
            <!-- Header text -->
            <h1 class="title-font tracking-tight font-extrabold text-2xl xs:text-3xl lg:text-4xl 2xl:text-6xl mb-4 text-gray-800">Analytics & Machine Learning for <span style="color: #6666FF;">Internal Audit</span></h1>
            
            <!-- Sub text -->
            <p class="mb-8 leading-relaxed text-xs sm:text-sm lg:text-lg xl:text-xl 2xl:text-2xl">
                Hands-on & tangable use-cases for your business. From internal auditors with several years of experience.
                <br>
                <br>
                Contact us now. 👇
            </p>
            ...
            <div>
                <div class="flex w-full justify-center items-end">
                    ...
                    <button id="heroEmailSubscribe" @click="subscribeEmail" type="button" style="background: #fc37f5;" class="flex-wrap relative my-auto disabled:opacity-50 text-sm xl:text-xl text-white justify-start rounded-full py-2 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:shadow-xl hover:scale-105 duration-300 ease-in-out">Send</button>
                </div>
